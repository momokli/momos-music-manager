...
-- Verification
SELECT 'Migration 002a applied: added last_fetched_at + remote_track_count to service_playlists' as status;
...
SELECT 'Migration 002 applied successfully: fetch tracking + tag parent resolution' as status;
